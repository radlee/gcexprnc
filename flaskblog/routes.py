...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='prof.lolito@gmail.com', recipients=[user.email])
    msg.body = f''' To Reset your password, visit the link : {url_for('reset_token', token=token, _external=True )}

    If you did not make this request then simply ignore this email and cno changes will be made
    '''
